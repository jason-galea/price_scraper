...
def export_to_db(db: SQLAlchemy, extracted_data: list) -> None:
    ...
    for product_data in extracted_data:
        ...
        #     "UTCTime": "2023-10-22T13: 39: 13.231445",
        #     "Retailer": "PCCG",
        #     "Title": "Samsung 870 EVO 2.5in SATA SSD 1TB",
        #     "URL": "https: //www.pccasegear.com/products/53095/samsung-870-evo-2-5in-sata-ssd-1tb",
        #     "PriceAUD": 129,
        #     "FormFactor": "2.5in",
        #     "Protocol": "SATA",
        #     "Brand": "Samsung",
    ...
    print("==> DEBUG: Exiting 'export_to_db()'")
